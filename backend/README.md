...
## Project Structure
    ...
    ├── testapiautoconnecto_82207  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_82207`
...
2. Clone this repo and `cd testapiautoconnecto_82207`
